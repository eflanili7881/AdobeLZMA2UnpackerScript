...
- To unpack all language assets, on application.json, change every language packages conditions from that langauge to your desired install language (i.e. en_US).
  ...
  - (unclarified) Some Adobe apps may require HyperDrive installer engine version <=5.3.1.470 (i.e. Adobe Photoshop Express) as I tested Adobe Photoshop Express version 3.12.1.0 (5.5.0.617 not worked but 5.3.1.470 does).
